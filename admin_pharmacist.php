...
if(isset($_SESSION['adminlogin'])){
	...
	if(isset($_POST['submit'])){
		...
		if($result->num_rows > 0) {
			...
			$sql1="INSERT INTO pharmacist (first_name,last_name,staff_id,postal_address,phone,email,username,password)
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">View pharmacist</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add pharmacist</a>
                                </li>
                            ...
                            <div class="tab-content">
											...
											<div class="table-responsive table-bordered">
												<table class="table">
													...
													<tr>
														...
														<td>
															<a href="update_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>">
																<i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i>
															</a>
														</td>
														<td>
															<a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>">
                                ...
                                <div class="tab-pane fade" id="profile">
									...
									<div class="panel panel-default">
										...
										<!-- /.panel-heading -->
										<div class="panel-body">
											<form role="form" name="form1" onsubmit="return validateForm(this);" action="admin_pharmacist.php" method="post">
												...
												<button type="submit" name="submit" class="btn btn-primary pull-right">Add Pharmacist</button>
											</form>
										</div>
									</div>
									<!--  End  Bordered Table  -->
