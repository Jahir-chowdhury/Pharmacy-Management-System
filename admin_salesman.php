...
if(isset($_SESSION['adminlogin'])){
	...
	$sql = "SELECT * FROM salesman WHERE username='$user'";
		$result = $conn->query($sql);
		
		if($result->num_rows > 0) {
			$message="<font style='color:#f6ff65;'>sorry the username entered already exists</font>";
		}else{
			$sql1="INSERT INTO salesman (first_name,last_name,staff_id,postal_address,phone,email,username,password)
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">View Salesman</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add Salesman</a>
                                </li>
                            ...
                            <div class="tab-content">
											...
											<div class="table-responsive table-bordered">
												<table class="table">
													...
													<tr>
														...
														<td>
															<a href="update_salesman.php?salesman_id=<?php echo $row['salesman_id']?>">
																<i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i>
															</a>
														</td>
														<td>
															<a href="delete_salesman.php?salesman_id=<?php echo $row['salesman_id']?>">
                                ...
                                <div class="tab-pane fade" id="profile">
									...
									<div class="panel panel-default">
										...
										<!-- /.panel-heading -->
										<div class="panel-body">
											<form role="form" name="form1" onsubmit="return validateForm(this);" action="admin_salesman.php" method="post">
												...
												<button type="submit" name="submit" class="btn btn-primary pull-right">Add salesman</button>
											</form>
										</div>
									</div>
									<!--  End  Bordered Table  -->
