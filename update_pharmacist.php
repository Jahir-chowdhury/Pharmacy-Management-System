                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="#profile" data-toggle="tab">Update pharmacist</a>
                                </li>
                                ...
                                <div class="tab-pane fade active in" id="profile">
									...
									<div class="panel panel-default">
										...
										<?php
											...
											$edit = "select * from pharmacist where pharmacist_id ='$pharmacist_id'";
											$result = $conn->query($edit);
											if($result->num_rows > 0) {
												while($row = $result->fetch_assoc()){
										?>
										
											<form role="form" name="form1" action="updated_pharmacist.php" method="POST">
											
												
												<div class="form-group">
													<input readonly style="cursor: not-allowed;" type="text" class="form-control" name="pharmacist_id" required value="<?php echo $row['pharmacist_id'] ?>">
												</div>
