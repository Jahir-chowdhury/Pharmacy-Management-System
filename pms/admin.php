                            ...
                            <div class="panel-body">
                                  <div class="alert alert-danger">
									...
									<h3 style="text-align:center;color:#e61717;">
										...
										<a href="admin_medistock.php" style="text-decoration:none;border:1px solid #E72832;border-radius: 50%;padding:5px 14px 5px 13px;background-color:#E72832;color:#fff;">
											<?php 
												echo $count;
											?>
										</a>
