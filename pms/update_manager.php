                                ...
                                <div class="tab-pane fade active in" id="profile">
									...
									<div class="panel panel-default">
										...
										<?php
											...
											$edit = "select * from manager where manager_id ='$manager_id'";
											$result = $conn->query($edit);
											if($result->num_rows > 0) {
												while($row = $result->fetch_assoc()){
										?>
											<form role="form" name="form1" action="updated_manager.php" method="POST">
											
												
												<div class="form-group">
													<input readonly style="cursor: not-allowed;" type="text" class="form-control" name="manager_id" required value="<?php echo $row['manager_id'] ?>">
												</div>
